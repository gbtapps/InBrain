...
public class S215BexSpeedTouchId5ControllerScript : MonoBehaviour
{
    ...
    //ゲームタイトル
    private string GameTitleString = "Speed Touch 5";
    ...
    //スコアキー
    private string ScoreKeyName = "SpeedTouchId5";
    ...
    List<string> SaveScoreDateTimeList;
    List<bool> SaveScoreUploadedList;

    //保存スコアロードリスト
    private List<int> ScoreList;
    List<string> ScoreDateTimeList;
    List<bool> ScoreUploadedList;
    ...
    void LoadSavedScoreToMakeRankAndNewScoreIndex()
    {
        ...
        if (existsKey == true)
        {
            ...
            SaveScoreDateTimeList = ES3.Load<List<string>>(ScoreKeyName);
            SaveScoreUploadedList = ES3.Load<List<bool>>(ScoreKeyName);
        ...
        else
        {
            ...
            SaveScoreDateTimeList = new List<string> { };
            SaveScoreUploadedList = new List<bool> { };
        }
        ...
        ScoreDateTimeList = SaveScoreDateTimeList;
        ScoreUploadedList = SaveScoreUploadedList;
...
//        Debug.Log("ScoreList2: " + ScoreList2);
        ...
        ScoreDateTimeList[NewScoreDataIndex] = DateTime.Now.ToString();
        ScoreUploadedList[NewScoreDataIndex] = false;
