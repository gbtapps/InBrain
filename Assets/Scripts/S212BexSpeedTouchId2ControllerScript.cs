...
public class S212BexSpeedTouchId2ControllerScript : MonoBehaviour
{
    ...
    //ゲームタイトル
    private string GameTitleString = "Speed Touch 2";
    ...
    //スコアキー
    private string ScoreKeyName = "SpeedTouchId2";
    ...
    void CreateButtons()
    {
        ...
        /*
        DebugText.text += ">CreateButtns()In";
        DebugText.text += ">Before DoSoundSetQuestions()";
        */

        //ボタン生成音
//        InstanceCommonGameCanvasManagerScript.DoSoundSetQuestions();

        DebugText.text += ">DoSoundSetQuestions()";
        ...
        DebugText.text += ">GetButtonWedthHeight";
        ...
        DebugText.text += ">DrawTargetAreaSizeXYFix";
        ...
        DebugText.text += ">UnityEngine.Random.Range";
