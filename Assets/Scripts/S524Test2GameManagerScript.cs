...
public class S524Test2GameManagerScript : MonoBehaviour
{
...
//    public GameObject buttonCanvas;
    ...
    //
    //TMT2TouchManagerの関数を使う
    //

    private GameObject TMT2TouchManager;
...
//        Debug.Log("buttonCount：" + buttonCount);
    ...
    void Start()
    {
        ...
        //TMT2TouchMnagerの機能を使う
        TMT2TouchManager = GameObject.Find("TMT2TouchManager");
        InstanceTMT2TouchManagerScript = TMT2TouchManager.GetComponent<TMT2TouchManagerScript>();
        ...
        while(i < a)
        {
            ...
            foreach (Transform child in preFabs.transform)
            {
                ...
                switch (i)
                {
                    ...
                    default: buttonSymbol = "ERR"; break;                    
                }

                //ボタンに記号をつける
                buttonNumText.text = buttonSymbol;
