...
public class Hot2gApplication : SingletonMonoBehaviour<Hot2gApplication>
{
    ...
    Hot2gApi m_API;
    public eMode m_Mode;
    NeuroFeedbacker m_nfb;
    DataStore dataStore;
    GainController m_gc;
    public DataLogger m_Logger = null;
	...
	bool m_Connect1st = true;

	public bool isConnect1st
	{
		get
		{
			return m_Connect1st;
    ...
    {
        return this.dataStore.batteryPercentage;
    }
    ...
    private void Start()
    {
        Debug.Log("Top: HOT2gApplication Start() called.");
    ...
    {
        Debug.Log("Top: Tying BLEConnection 111");
        m_Mode = eMode.Scan;
        Debug.Log("Top: Tying BLEConnection 2");
        m_ScanSuccess = Success;
        Debug.Log("Top: Tying BLEConnection 3");
        m_ScanError = Error;
        Debug.Log("Top: Tying BLEConnection 4");


        Debug.Log("Top: Tying BLEConnection m_API=" + m_API.ToString());
        Debug.Log("Top: Tying BLEConnection m_API=" + m_API.IsApiEnabled().ToString());
        ...
        Debug.Log("Top: Tying BLEConnection 5");
    ...
    IEnumerator InitSetting()
    {
		...
		Hot2gApplication.Instance.API.setHRSamplingInfo(Hot2gEnumerations.EnumHot2gHRTransRate.e1HZ);
		yield return new WaitForSeconds(SettingWait);
		Hot2gApplication.Instance.API.getHot2gIf().UpdateReport8A();
    ...
    void OnMeasureDataEvent(Hot2gEnumerations.EnumHot2gMeasResult e, object meas_data, string device_address)
    {
        ...
        Debug.Log(this.m_Mode.ToString());//-TKTK
    ...
    public void StopRecieve()
    {
        ...
        if(m_API != null)
        {
            ...
            {
                m_API.stopMeasure();
                m_API.disconnectBtDevice();
            }
        }
    }

    void adjustGain(NeuroFeedbacker nfb, GainController gc, Hot2gEnumerations.EnumHot2gMeasResult e, object data, DataLogger logger)
    {
        switch (e)
        {
     ...
     * ゲイン調整済みデータ受信時の動作
     */
    private void receiveData(NeuroFeedbacker nfb, Hot2gEnumerations.EnumHot2gMeasResult e, object data, DataLogger logger)
    {        
        switch (e)
        {
            /*XB-01*/
     ...
     * 強制ゲインリセット
     */
    private void resetGain(NeuroFeedbacker nfb, GainController gc)
    {
        nfb.resetBrainCals();
    ...
    public double ActivenessesAverage2()
    {
        if (m_nfb == null)
        {
            return 0.5;
        ...
        return m_nfb.activenessAverage2;
    }
