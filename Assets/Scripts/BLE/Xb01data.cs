...
public class Xb01data
{
    ...
    public double pulseRateC1L1;
    public double pulseRateC2L1;
    public double pulseRateC3L1;
    public double pulseRateC1L3;
    public double pulseRateC2L3;
    public double pulseRateC3L3;
	...
	public string ConvCSV()
	{
        return tick + "," + heartRate + "," + l1 + "," + l3 + "," + l1sa + "," + l3sa + "," +
               ...
               pulseRateC1L1 + "," + pulseRateC2L1 + "," + pulseRateC3L1 + "," +
               pulseRateC1L3 + "," + pulseRateC2L3 + "," + pulseRateC3L3 + "," +
               pulseCoeff1L1 + "," + pulseCoeff2L1 + "," + pulseCoeff3L1 + "," + 
               pulseCoeff1L3 + "," + pulseCoeff2L3 + "," + pulseCoeff3L3 + "," +
               ac1 + "," + ac3;
	}
